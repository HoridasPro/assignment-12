    ...
    >
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="max-w-2xl">
          <span className="inline-block bg-[#f0fdf4] text-[#166534] px-4 py-1 rounded-full text-sm font-bold mb-6">
            About Us
          </span>

          <h2
            className="text-5xl lg:text-6xl font-bold text-[#0f172a] leading-tight mb-8"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="bg-white p-10 rounded-[2rem] shadow-sm border border-gray-50 flex flex-col items-center text-center transition-all hover:shadow-md hover:-translate-y-1"
            >
